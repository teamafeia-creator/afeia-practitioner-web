...
/**
 * GET /api/consultants/[consultantId]/messages
 * Récupérer tous les messages d'une conversation praticien-consultant
 */
export async function GET(
  ...
  try {
    ...
    // 4. Marquer les messages du consultant comme lus
    await supabase
      .from('messages')
...
/**
 * POST /api/consultants/[consultantId]/messages
...
export async function POST(
  ...
  try {
    ...
    // 5. Créer une notification pour le consultant
    try {
