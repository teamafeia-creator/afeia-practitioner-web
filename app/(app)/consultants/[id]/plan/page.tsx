...
import { createPlan, sharePlanWithConsultant, PlanContent } from '@/services/plans';
...
export default function CreatePlanPage() {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      const result = await createPlan(consultantId, content);
  ...
  const handleSaveAndShare = async () => {
    ...
    try {
      ...
      // Share the plan
      const shared = await sharePlanWithConsultant(result.planId);
      ...
      if (!shared) {
        ...
        setToast({
          title: 'Plan envoye',
          description: `Le plan a ete partage avec ${consultant?.name || 'le consultant'}.`,
          variant: 'success',
        });
      }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => router.push(`/consultants/${consultantId}`)}>
            Annuler
          </Button>
      ...
      <div className="flex justify-end gap-2 pb-8">
        ...
        <Button variant="primary" onClick={handleSaveAndShare} loading={saving}>
          Enregistrer et envoyer au consultant
        </Button>
      </div>
