...
export default function CreatePlanPage() {
  ...
  const createDemoPlan = async () => {
    ...
    try {
      // Récupérer le consultant TEST01
      ...
      if (!consultant) throw new Error('Consultant introuvable')
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl p-8 shadow text-center">
          <h1 className="text-2xl font-bold mb-4">Créer un conseillancier de test</h1>
          <p className="text-gray-600 mb-6">
            Cela va créer un plan avec 3 compléments alimentaires pour le consultant TEST01
          </p>
          ...
          <div className="mt-6">
            <a href="/consultant/demo" className="text-blue-600 hover:underline">
              ← Retour au dashboard
            </a>
          </div>
        </div>
