  ...
  const handleResendCode = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setToast({
          title: 'Code renvoye',
          description: `Un nouvel email a ete envoye a ${patientEmail}.`,
          variant: 'success'
        });
      } else {
        setToast({
      ...
      <AnimatePresence>
        ...
        >
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-warmgray mt-1">
                Partagez ce code avec {patientName} pour qu&apos;il puisse activer son compte.
              </p>
            </div>
          </div>
          ...
          <p className="text-xs text-warmgray mt-4 text-center">
            Le patient recevra un email a {patientEmail} avec les instructions d&apos;activation.
