...
export function ActivationCodeModal({
  ...
  return (
    <Modal
      ...
      description={`Le code d'activation a ete envoye a ${patientName}.`}
      size="md"
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3 p-4 bg-neutral-50 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm text-teal-dark">{patientEmail}</p>
          </div>
        </div>

        {/* Instructions */}
        <p className="text-sm text-warmgray text-center">
          Le patient peut utiliser ce code pour activer son compte dans l&apos;application mobile.
