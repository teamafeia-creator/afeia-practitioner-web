...
-- DEV ONLY: destructive reset for local/dev environments.
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_practitioner();
...
-- =========================================================
-- Rebuild schema (same as 00_setup_safe.sql)
-- =========================================================
BEGIN;
...
-- INSERT INTO public.practitioners (id, email, full_name)
-- VALUES ('00000000-0000-0000-0000-000000000000', 'dev@afeia.test', 'Dev Practitioner');
-- INSERT INTO public.patients (practitioner_id, name, email, status, is_premium, circular_enabled)
-- VALUES ('00000000-0000-0000-0000-000000000000', 'Patient Démo', 'patient@afeia.test', 'standard', false, false);
